...
\namesection{François}{De Keersmaeker}{
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\iconwidth]{images/email.png} \href{mailto:francois.dekeersmaeker@proton.me}{\bf{francois.dekeersmaeker@proton.me}} \\
        \includegraphics[width=\iconwidth]{images/linkedin.png} \href{https://www.linkedin.com/in/françois-de-keersmaeker-11301a210}{\bf{LinkedIn}}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\iconwidth]{images/github.png} \href{https://github.com/fdekeers}{\bf GitHub} \\
        \includegraphics[width=\iconwidth]{images/researchgate.png} \href{https://www.researchgate.net/profile/Francois-De-Keersmaeker}{\bf{ResearchGate}}
    \end{minipage}
}{pic_cropped.png}
...
\begin{itemize}
    ...
    \item \href{https://github.com/smart-home-network-security/smart-home-testbed}{\texttt{smart-home-testbed}}
...
TMA 2024 PhD School\\
\location{May 22, 2024 | Dresden, Germany}
\descript{Best Poster}
GRASCOMP 2024 Doctoral Day\\
\location{Sept. 9, 2024 | Louvain-la-Neuve, Belgium}
%\vspace{5pt}
...
\includegraphics[scale=0.015]{images/uk.png}  English: C2 \\
...
\subsection{Others}
\includegraphics[width=12pt]{images/car.png} Driving license: Category B
...
\location{September 2021 - January 2026 | Louvain-la-Neuve, Belgium}
...
\location{March 2019 - July 2019 | Louvain-la-Neuve, Belgium}
...
\subsection{Ph.D in Computer Engineering}
\descript{UCLouvain | ICTEAM - INGI}
\location{Grad. April 2026 | Louvain-la-Neuve, Belgium}
F.R.S.-FNRS candidate \\
Thesis: Profile-Based Security and In-Depth Characterization of Smart Home Network Communications
\sectionsep

\subsection{MS in Computer Engineering}
\descript{UCLouvain | Louvain School of Engineering}
